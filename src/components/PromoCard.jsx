...
const PromoCard = ({ id, title, description, imageUrl }) => {
  return (
    <Card className="w-full max-w-md mx-auto overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-200 transform hover:-translate-y-2 hover:scale-105 group cursor-pointer">
      {/* Image Section */}
